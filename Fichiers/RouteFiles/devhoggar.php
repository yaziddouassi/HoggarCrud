...
Route::post('/admin/crud-generator/create',[\Hoggar\Hoggar\Generator\Hoggarcrud::class, 'create'])->middleware('auth');
        
Route::get('/admin/wizard-generator', [\App\Http\Controllers\Hoggar\DevGenerator\Page2Controller::class, 'index'])->middleware('auth');
Route::post('/admin/wizard-generator/create', [\Hoggar\Hoggar\Generator\Hoggarcrud::class, 'create2'])->middleware('auth');
